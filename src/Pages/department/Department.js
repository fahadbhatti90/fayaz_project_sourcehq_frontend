...
export default function Department() {
  ...
  const fetchData = async () => {
    await axios
      ...
      .then(({ data }) => {
        setDepartment([...data.all_job_categories]);
        setFilterDepartment([...data.all_job_categories]);
      })
      .catch(({ data }) => {
        console.log(data);
      });
  ...
  const handleSearch = (event) => {
    ...
    setFilterDepartment(tempLocations);
          ...
          <div className="form__card">
            <div className="form__card__title__wrap d-flex align-items-center justify-content-between">
              <div className="form__card__title__wrap__left d-flex align-items-center ">
                ...
                <div className="form__card__title border-0">Job Department</div>
              </div>
              ...
              <div className="form__card__flex__right">
                <div className="form__card__body__wrapper">
                  ...
                  <div className="data__table__wrapper">
                    ...
                    {filterDepartment.length > pagePostsLimit && (
                      <Pagination
                        ...
                        totalItems={filterDepartment.length}
                        pageNeighbours={2}
                      />
                    )}
                  </div>
