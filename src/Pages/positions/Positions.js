...
export default function Positions() {
  ...
  const fetchData = async () => {
    await axios
      .get(`/ShowAllJobPositions`, {
        headers: headers,
      })
      .then(({ data }) => {
        setPositions([...data.all_job_positions]);
        setFilterPositions([...data.all_job_positions]);
      })
      .catch(({ data }) => {
        console.log(data);
      });
  ...
  const handleSearch = (event) => {
    ...
    setFilterPositions(tempLocations);
          ...
          <div className="form__card">
            <div className="form__card__title__wrap d-flex align-items-center justify-content-between">
              <div className="form__card__title__wrap__left d-flex align-items-center ">
                ...
                <div className="form__card__title border-0">Job Positions</div>
              </div>
              ...
              <div className="form__card__flex__right">
                <div className="form__card__body__wrapper">
                  ...
                  <div className="data__table__wrapper">
                    ...
                    {filterPositions.length > pagePostsLimit && (
                      <Pagination
                        ...
                        totalItems={filterPositions.length}
                        pageNeighbours={2}
                      />
                    )}
                  </div>
            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="single__input__item">
                  <label htmlFor="">
                    Positions name <span className="text-red">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control"
