...
export default function Category() {
  ...
  const fetchData = async () => {
    await axios
      .get(`/ShowAllJobCategories`, {
        headers: headers,
      })
      .then(({ data }) => {
        setCategory([...data.all_job_categories]);
        setFilterCategory([...data.all_job_categories]);
      })
      .catch(({ data }) => {
        console.log(data);
      });
  ...
  const handleSearch = (event) => {
    ...
    setFilterCategory(tempLocations);
          ...
          <div className="form__card">
            <div className="form__card__title__wrap d-flex align-items-center justify-content-between">
              <div className="form__card__title__wrap__left d-flex align-items-center ">
                ...
                <div className="form__card__title border-0">Job Category</div>
              </div>
              ...
              <div className="form__card__flex__right">
                <div className="form__card__body__wrapper">
                  ...
                  <div className="data__table__wrapper">
                    ...
                    {filterCategory.length > pagePostsLimit && (
                      <Pagination
                        ...
                        totalItems={filterCategory.length}
                        pageNeighbours={2}
                      />
                    )}
                  </div>
